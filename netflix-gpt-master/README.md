...
[![GitHub Repository](https://img.shields.io/badge/GitHub%20Repo-Netflix%20GPT-green)](https://github.com/DhruvSangra/netflix-gpt)
...
1. Clone the repository to your local machine:
   ...
   ```shell
   git clone https://github.com/DhruvSangra/netflix-gpt.git
   ```
...
If you'd like to contribute to this project, have suggestions for improvement, or wish to add more features, please feel free to submit issues or pull requests on [GitHub](https://github.com/DhruvSangra/netflix-gpt). Your contributions are valued! 🚀
